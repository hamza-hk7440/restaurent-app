...
class IUserRepository(IRepository[Student], ABC):
    @abstractmethod
    ...
    async def unban_student(self, student_id: str) -> None:
        pass
    @abstractmethod
    async def edit_student_infos(self, student_id: str, first_name: str = None, last_name: str = None, email: str = None, establishment: str = None, email_verified: bool = None, email_verified_at: datetime = None) -> None:
        pass
    @abstractmethod
